...
import com.yan.springframework.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object doCreateBean(String beanName, BeanDefinition beanDefinition, Object[] args){
        ...
        try {
            ...
            // 处理循环依赖，将实例化后的Bean对象提前放入缓存，暴露给其他对象依赖
        ...
        try {
            ...
            for (PropertyValue pv : propertyValues.getPropertyValues()) {
                ...
                if (value instanceof BeanReference) {
                    // 实际上（BeanReference）value持有的是UserDao的类，通过getName方法获取”userDao“，然后实例化
    ...
    public Object applyBeanPostProcessorsAfterInitialization(Object existingBean, String beanName) throws BeansException {
        Object result = existingBean;
        for (BeanPostProcessor beanPostProcessor : getBeanPostProcessors()) {
            Object current = beanPostProcessor.postPrecessorAfterInitialization(result, beanName);
            if (null == current){
                return result;
            }
            result = current;
